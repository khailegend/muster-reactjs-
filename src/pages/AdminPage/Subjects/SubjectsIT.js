...
class SubjectsIT extends Component {
    constructor(props) {
        super(props);
        this.state = {
            subjects : [],
                    ...
                    <Grid className='mt-4' key={index} item lg={5} md={5} sm={5} xs={12}>
                        ...
                        >
                            <Card className='cardSubject'>
                                <Fab style={{ outline: '0' }} color="primary">
                                    <b>{subject.id}</b>
                                </Fab>
                            </Card>
        ...
        return (
            <div className='subjectIT'>
                <Alert
                    ...
                    severity="info"
                    color="info"
                    icon={<ImportantDevicesIcon className='mt-1' />}
                    action={ role == "admin" && ( 
                        <IconButton
                            aria-label="close"
                            color="inherit"
                ...
                >
                    <b style={{ fontSize: '150%', textShadow: '0.1em 0.1em 0.2em black' }}>INFORMATION TECHNOLOGY</b>
                </Alert>
                ...
                >
                    <DialogTitle id="alert-dialog-title" >
                        <b style={{ color: '#34495e' }} >
                            <AddIcon />
                            Adding Subjects To The INFORMATION TECHNOLOGY
                        </b>
                        <hr />
                    </DialogTitle>
                    <DialogContent>
...
export default connect(mapStateToProps, null)(SubjectsIT);
